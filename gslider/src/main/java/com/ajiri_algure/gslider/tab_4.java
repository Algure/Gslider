...
public class tab_4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (GslideActivity.BDType.matches("drawable")&&GslideActivity.pics.length>=5){
            frameLayout.setBackground(GslideActivity.pics[4]);
        }else if (GslideActivity.BDType.matches("bitmap")&&GslideActivity.bitmaps.length>=5){
            ImageView imv=v.findViewById(R.id.imv);
            imv.setImageBitmap(GslideActivity.bitmaps[4]);
