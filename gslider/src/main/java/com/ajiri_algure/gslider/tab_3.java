...
public class tab_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (GslideActivity.BDType.matches("drawable")&&GslideActivity.pics.length>=4){
            frameLayout.setBackground(GslideActivity.pics[3]);
        }else if (GslideActivity.BDType.matches("bitmap")&&GslideActivity.bitmaps.length>=4){
            ImageView imv=v.findViewById(R.id.imv);
            imv.setImageBitmap(GslideActivity.bitmaps[3]);
