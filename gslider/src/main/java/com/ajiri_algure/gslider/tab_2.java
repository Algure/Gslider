...
public class tab_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (GslideActivity.BDType.matches("drawable")&&GslideActivity.pics.length>=3){
            frameLayout.setBackground(GslideActivity.pics[2]);
        }else if (GslideActivity.BDType.matches("bitmap")&&GslideActivity.bitmaps.length>=3){
            ImageView imv=v.findViewById(R.id.imv);
            imv.setImageBitmap(GslideActivity.bitmaps[2]);
